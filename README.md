...
- **Last updated:** 20 August 2026, 19:50 UTC
- **Refreshed:** daily at 06:00 UTC
- **How this is measured:** [METHOD.md](./METHOD.md)

## Representativeness

The top 50 EVM chains by TVL, ranked by DefiLlama with endpoints from `ethereum-lists/chains`. The last run produced a verdict covering **99.7% of EVM TVL** ($71.2B).
