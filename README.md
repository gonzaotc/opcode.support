...
- **Last updated:** 23 August 2026, 06:44 UTC
...
- both operators answered with the same client string, so possibly one node behind two names: Base, Hyperliquid L1, Avalanche, Flare, X Layer, Gnosis, Mezo, Berachain, Fraxtal, Celo
