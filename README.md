...
- **Last updated:** 2 September 2026, 10:51 UTC
...
- both operators answered with the same client string, so possibly one node behind two names: Hyperliquid L1, Avalanche, Flare, X Layer, Gnosis, Mezo, Berachain, Hedera, Fraxtal, Celo
