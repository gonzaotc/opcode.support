...
| `config/selection.json` | topN, reference chain, chain id overrides, exclusions, seed RPCs, documented answers |
...
- `data/chains.json` is pinned. Regenerate deliberately, never in CI.
